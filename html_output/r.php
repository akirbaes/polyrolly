...
<table>
  <tr><th>Rolling pattern</th><th>Stability pattern</th></tr>
...
echo "Tiling: " . $_GET["t"] . "";
?>
</th><th>Polyhedron Net</th></tr>
  
  <tr>

<?php
echo "<td><img class=small src=t/" . ($_GET["t"]) . ".png height=400px></td>";
echo "<td><img class=small src=n/" . ($_GET["t"]) . "@" . ($_GET["p"]) . ".png.svg width=400px><br/></td>";

//echo "<td><img class=small src=p/" . ($_GET["p"]) . ".png height=400px><br/>Image from Wikipedia.</td>";
?>
  </tr>
  <tr>
  <td>
